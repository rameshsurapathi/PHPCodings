...
$price = pricergx($price,30);

if($price!=""&&$link!=""){

echo '<table border="0" width="100%" height="20px" bgcolor="#FFFFFF">
<tr>
<td width="40%" valign="middle" style="color:grey;"><img src="Websites/Letsshop/letsshop.png"></td>
...
$sqlquery = mysql_query("select ProductId from letsshop where ProductId='$productid'") or die(mysql_error());
...
$newquery = mysql_query("Update letsshop SET Price='$price',Link='$link',Title='$title' where ProductId='$productid'") or die(mysql_error());
}

else{ // Insert product details into website table for first time
$newquery = mysql_query("Insert into letsshop(WebsiteId,ProductId,Price,Link,DeliveryTime,Title,Time) values('30','$productid','$price','$link','Delivery in 5-7 days.','$title',now())") or die(mysql_error());
}
