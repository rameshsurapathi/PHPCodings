...
$html = curl('http://shoppingwopping.in/index.php/catalogsearch/result/index/?q='.$extra_link.'');
$dom = new DOMDocument();
@$dom->loadHTML($html);
...
$price = pricergx2($price,32);

if($price!=""&&$link!=""){

echo '<table border="0" width="100%" height="20px" bgcolor="#FFFFFF">
<tr>
<td width="40%" valign="middle" style="color:grey;"><img src="Websites/Shoppingwopping/shoppingwopping.png"></td>
...
$sqlquery = mysql_query("select ProductId from shoppingwopping where ProductId='$productid'") or die(mysql_error());
...
$newquery = mysql_query("Update shoppingwopping SET Price='$price',Link='$link',Title='$title' where ProductId='$productid'") or die(mysql_error());
}

else{ // Insert product details into website table for first time
$newquery = mysql_query("Insert into shoppingwopping(WebsiteId,ProductId,Price,Link,DeliveryTime,Title,Time) values('32','$productid','$price','$link','Delivery in 3 Business days.','$title',now())") or die(mysql_error());
}
