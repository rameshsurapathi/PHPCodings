...
$html = curl('https://www.lenskart.com/advancedsearch/result/?q='.$extra_link.'');
$dom = new DOMDocument();
@$dom->loadHTML($html);
...
<tr>
<td width="40%" valign="middle" style="color:grey;"><img src="Websites/Lenskart/lenskart.png"></td>
...
$sqlquery = mysql_query("select ProductId from lenskart where ProductId='$productid'") or die(mysql_error());
...
$newquery = mysql_query("Insert into lenskart(WebsiteId,ProductId,Price,Link,DeliveryTime,Title,Time) values('53','$productid','$price','$link','2-5 Working days.','$title',now())") or die(mysql_error());
}
