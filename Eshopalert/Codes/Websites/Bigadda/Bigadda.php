...
<tr>
<td width="40%" valign="middle" style="color:grey;"><img src="Websites/Bigadda/bigadda.png"></td>
...
$sqlquery = mysql_query("select ProductId from bigadda where ProductId='$productid'") or die(mysql_error());
...
$newquery = mysql_query("Update bigadda SET Price='$price',Link='$link',Title='$title' where ProductId='$productid'") or die(mysql_error());
}

else{ // Insert product details into website table for first time
$newquery = mysql_query("Insert into bigadda(WebsiteId,ProductId,Price,Link,DeliveryTime,Title,Time) values('19','$productid','$price','$link','Delivery In 7 - 10 Days.','$title',now())") or die(mysql_error());
}
