...
<td align="right"><span style="font-size:13px;">Welcome </span></td><td>
<?php
...
$query = mysql_query("select LastLogin from users where UserId='".$_SESSION['authenticateduser']."'") or die(mysql_error());
while($row = mysql_fetch_array($query)){
$lastlogin = $row['LastLogin'];
}
$query1 = mysql_query("select QuestionId from comments where CUserId='".$_SESSION['authenticateduser']."' and Date>='$lastlogin'") or die(mysql_error());
$res1 = mysql_num_rows($query1);
$query2 = mysql_query("select QuestionId from likes where LUserId='".$_SESSION['authenticateduser']."' and Date>='$lastlogin'") or die(mysql_error());
$res2 = mysql_num_rows($query2);
$query3 = mysql_query("select QuestionId from answers where UserId='".$_SESSION['authenticateduser']."' and Date>='$lastlogin'") or die(mysql_error());
...
<td align="right">
<table border="0"><tr>
<td align="center"><div style="background-color:#85a950;height:28px;width:140px;color:#FFFFFF;font-size:20px;">Ask Question</div></td>
<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
<td align="center"></td>
<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td></tr></table>
</td>
