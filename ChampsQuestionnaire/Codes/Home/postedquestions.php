...
$query = mysql_query("select * from questions where UserId='".$_SESSION['authenticateduser']."'") or die(mysql_error());
if(mysql_num_rows($query)>0){
include('commoncode.php');
}
else{
echo '<div align="center" style="font-size:24px;color:red;">No Questions are posted</div><div style="height:390px;"></div>';
}
?>
