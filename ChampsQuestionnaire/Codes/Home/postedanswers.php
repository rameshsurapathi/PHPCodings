...
Click on the questions,to see your answers.<br/>
<?php
include_once('../Config/Config.php');
$mainquery = mysql_query("select QuestionId from answers where UserId='".$_SESSION['authenticateduser']."'") or die(mysql_error());
...
echo '<div align="center" style="font-size:24px;color:red;">No answers are posted</div><div style="height:390px;"></div>';
}
?>
