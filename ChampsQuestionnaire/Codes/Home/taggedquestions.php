...
$mainquery = mysql_query("select QuestionId from comments where CUserId='".$_SESSION['authenticateduser']."' 
...
echo '<div align="center" style="font-size:24px;color:red;">No Questions are tagged</div>';
}
?>
